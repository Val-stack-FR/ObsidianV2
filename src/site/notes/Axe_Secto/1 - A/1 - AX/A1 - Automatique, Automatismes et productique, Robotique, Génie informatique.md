...
*   **Terme anglais (EN) :** *Automation, Robotics and Computer Engineering*.
*   **Objets d'entrée (Inputs) :** Signaux physiques, code informatique, énergie.
*   **Objets de sortie (Outputs) :** Mouvements, actions physiques, données traitées.
