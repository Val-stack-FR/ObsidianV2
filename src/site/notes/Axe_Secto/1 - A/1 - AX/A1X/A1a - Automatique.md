...
*Le vocabulaire métier indispensable.*

| Concept Français | Concept Anglais (EN) | Verbes associés (Collocations) |
| :--- | :--- | :--- |
| **Boucle fermée** | *Closed-loop* | boucler, rétroagir |
| **Stabilité** | *Stability* | converger, diverger |
| **Perturbation** | *Disturbance* | rejeter, compenser |

## 3. Méthodologie
*   **Approche théorique :** Théorie du contrôle (*Control Theory*).
*   **Objectif clé :** Maintenir un système à sa consigne malgré les perturbations extérieures.
